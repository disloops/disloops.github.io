// This was originally taken from: https://deckbox.org/help/tooltips
//
// Much appreciated that they allow people to link to their Magic 
// card tooltips. Thanks Deckbox! I modified it to only work for
// Magic cards (not the other trading cards) since that's what I'm
// using it for. Most people probably link directly to this script
// on their site but I didn't want to do that for security reasons.
...
/**
 * Main tooltip type. Will be initialized for the image tooltips.
 */
...
Deckbox._ = {
    ...
    needsTooltip: function(el) {
        ...
        return href.match(/^https?:\/\/deckbox\.org\/mtg\/.+/);
    },

    tooltip: function(which)  {
        return this._iT = this._iT || new Deckbox.ui.Tooltip('deckbox_i_tooltip', 'image');
    },
